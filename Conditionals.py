...
score = int(input("Enter your exam score "))  # Exam score using elif,else construct
if score > 85:
      print("Distinction")
elif score > 65 :     
      print("Pass")
...
score = int(input("Enter your exam score "))  # to achieve the same (Exam score) without using elif construct
key = []
if score > 85 : key = 1
